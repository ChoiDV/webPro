	...
	<section>
		<form action="updatePro.jsp" name="frm" onsubmit="return chk()">
			<table>
				...
				<tr><th>회원전화</th><td><input type="text" name="phone" value="<%=dto.getPhone()!=null ? dto.getPhone() : ""%>"></td></tr>
				<tr><th>회원주소</th><td><input type="text" name="address" value="<%=dto.getAddress()!=null ? dto.getAddress() : "" %>"></td></tr>
				...
				<tr><th>도시코드</th><td><input type="text" name="city" value="<%=dto.getCity()!=null ? dto.getCity() : "" %>"></td></tr>
				<tr>
