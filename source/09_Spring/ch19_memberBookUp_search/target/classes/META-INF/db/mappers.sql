...
SELECT * FROM BOOK WHERE BTITLE LIKE '%'||'JSP'||'%' ORDER BY BTITLE; 
SELECT * FROM BOOK WHERE BWRITER LIKE '%'||'작'||'%' ORDER BY BTITLE;
SELECT * FROM BOOK WHERE BTITLE LIKE '%'||'JSP'||'%' OR BWRITER LIKE '%'||'작'||'%' ORDER BY BTITLE;
...
SELECT COUNT(*) FROM BOOK WHERE BTITLE LIKE '%'||'JSP'||'%';
SELECT COUNT(*) FROM BOOK WHERE BWRITER LIKE '%'||'작'||'%';
SELECT COUNT(*) FROM BOOK WHERE BTITLE LIKE '%'||'JSP'||'%' OR BWRITER LIKE '%'||'작'||'%';
