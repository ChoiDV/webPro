...
<form action="${conPath }/naverSmartEditModify.do" method="post" enctype="multipart/form-data">
	<table>
		<caption>${dto.bno }번 글수정</caption>
		<tr><th>글제목</th>
				<td style="text-align: left;"><input type="text" name="btitle" required="required" value="${dto.btitle}"></td>
		</tr>
		<tr><th>글본문</th>
				<td>
					<textarea rows="5" cols="32" name="bcontent" id="bcontent">${dto.bcontent}</textarea>
		...
		<tr><th>첨부파일</th>
				<td><input type="file" name="bfile">첨부파일명 : <a href="${conPath }/naverSmartEditUp/${dto.bfile}">${dto.bfile}</a></td>
		<tr>
			<td colspan="2">
